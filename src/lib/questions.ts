// 文件名: src/lib/questions.ts (v2.0 迭代版)
...
export const QUESTIONS: Question[] = [
    ...
    { id: 3, text: "你对养宠物（如猫狗）的态度和意愿？", dimension: 'lifestyle', options: [{ value: 1, label: "完全不能接受" }, { value: 2, label: "很难接受" }, { value: 3, label: "中立" }, { value: 4, label: "可以接受" }, { value: 5, label: "必须有" }] }, // Q3 拆分：宠物
    { id: 4, text: "你对伴侣吸烟、饮酒或其他成瘾品的态度？", dimension: 'lifestyle', options: [{ value: 1, label: "零容忍" }, { value: 2, label: "尽量避免" }, { value: 3, label: "中立" }, { value: 4, label: "适度即可" }, { value: 5, label: "无所谓" }] }, // Q3/Q13 整合优化
    ...
    { id: 36, text: "你对**生育**下一代的明确态度？", dimension: 'intimacy', options: [{ value: 1, label: "坚决丁克" }, { value: 2, label: "倾向丁克" }, { value: 3, label: "顺其自然" }, { value: 4, label: "倾向生育" }, { value: 5, label: "必须生育" }] }, // 从 Q44 优化而来
...
export const DIMENSION_DETAILS: Record<Dimension, { title: string; description: string }> = {
    ...
    intimacy: { title: "第四步：亲密与家庭观", description: "关于亲密需求、生育观、原生家庭和对安全感的深层考察。" }, // 新增维度
